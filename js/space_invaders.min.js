...
$jscomp.polyfill("Array.from",function(a){return a?a:function(a,d,f){$jscomp.initSymbolIterator();d=null!=d?d:function(a){return a};var e=[],h=a[Symbol.iterator];if("function"==typeof h)for(a=h.call(a);!(h=a.next()).done;)e.push(d.call(f,h.value));else for(var h=a.length,q=0;q<h;q++)e.push(d.call(f,a[q]));return e}},"es6-impl","es3");
(function(){function a(b){if(w&&!m){var c=g.offsetLeft-F.offsetLeft-1;"ArrowLeft"===b.key&&0<=c-25?(b.preventDefault(),g.style.marginLeft=c-25+"px"):"ArrowRight"===b.key&&c+25<=F.offsetWidth-100?(b.preventDefault(),g.style.marginLeft=c+25+"px"):" "===b.key&&x&&(b.preventDefault(),n++,x=!1,window.sleep(G).then(function(){x=!0}),e())}}function e(){var b=document.createElement("div");b.classList.add("laser");b.style.left=g.offsetLeft+45+"px";b.style.top=g.offsetTop-30+"px";g.appendChild(b);for(var c=
{i:0};28>c.i;c={i:c.i},c.i++)window.sleep(c.i*y).then(function(c){return function(){b.style.top=g.offsetTop-50-25*c.i+"px";p().forEach(function(c){z(c,b)&&d(c,b)})}}(c));window.sleep(28*y).then(function(){b.parentElement&&(t=0,b.remove())})}function d(b,c){c.remove();b.remove();u++;t++;k+=(Math.floor(t/10)+1)*Number(b.attributes.points.value);document.getElementById("pointsDisplay").classList.add("pointsFlash");window.sleep(750).then(function(){return document.getElementById("pointsDisplay").classList.remove("pointsFlash")});
document.getElementById("points").textContent=k;if(H=!0,0===t%10)I("Enemies Retreat!"),v("ver",-1),H=!1;u===J&&(K("You Win!"),window.setCookie("playerWinsSpace",A+1,10),document.getElementById("playerWins").textContent=A+1,document.getElementById("myCanvas").style.display="block")}function f(b){if(!m){var c=document.createElement("div");c.classList.add("enemyLaser");var a=p()[window.randomIntFromInterval(0,p().length-1)].attributes.currentCell.value;document.getElementById("cell-"+a).appendChild(c);
l(c,b)}}function l(b,c){z(g,b)?(g.remove(),b.remove(),E()):b.offsetTop>=g.offsetTop?(b.remove(),c&&!m&&window.sleep(window.randomIntFromInterval(350,550)).then(function(){f(c)})):window.sleep(200).then(function(){b.style.marginTop=Number(b.style.marginTop.substring(0,b.style.marginTop.length-2))+25+"px";l(b,c)})}function h(){w||(document.getElementById("start").classList.remove("startButtonFlash"),window.modal("Start!",1500),window.sleep(1500).then(function(){w=!0;L();f(!0)}))}function q(){p().some(function(b){return z(b,
...
0<n&&(document.getElementById("statsContainer").style.display="flex",document.getElementById("shotsFired").textContent=n,document.getElementById("accuracy").textContent=Math.floor(u/n*100)+"%");window.setCookie("currentPointsSpace",k,10);k>N&&!M&&(window.setCookie("highScoreSpace",k,10),document.getElementById("highScore").textContent=k);document.getElementById("reload").textContent="Play Again"}function I(b){var c=document.getElementById("upgradeText");c.textContent=b;c.classList.add("flash");window.sleep(4950).then(function(){c.classList.remove("flash");
c.textContent=""})}function L(){m||(O("0")&&!r?(v("ver",1),r=!0,C++,D=1):O("46")&&!r?(v("ver",1),r=!0,C++,D=-1):(v("hor",D),r=!1),15===window.randomIntFromInterval(1,15)&&f(!1),0===n%10&&.65<u/n&&!P&&(I("Laser Upgraded!"),G=500,y=150,P=!0),q(),m||window.sleep(375-16*C).then(function(){return L()}))}function v(b,c){p().forEach(function(a){var d=Number(a.attributes.currentCell.value.split("-")[0]),e=Number(a.attributes.currentCell.value.split("-")[1]);a=a.parentElement.removeChild(a);d="hor"===b?d+
"-"+(e+c):d+c+"-"+e;a.attributes.currentCell.value=d;document.getElementById("cell-"+d).appendChild(a)})}var x=!0,H=!1,w=!1,m=!1,J=0,u=0,n=0,C=1,D=1,r=!1,y=175,G=550,P=!1,t=0,k=Number(window.getCookie("currentPointsSpace")),M=!1,N=Number(window.getCookie("highScoreSpace")),A=Number(window.getCookie("playerWinsSpace")),B=Number(window.getCookie("playerLossesSpace")),Q=["images/enemy-4.png","images/enemy-2.png","images/enemy-3.png","images/enemy-1.png"],g=document.getElementById("ship"),F=document.getElementById("gameBoard"),
p=function(){return Array.from(document.getElementsByClassName("enemyShip"))},z=function(b,a){return!(a.offsetLeft>b.offsetWidth+b.offsetLeft||b.offsetLeft>a.offsetWidth+a.offsetLeft||a.offsetTop>b.offsetHeight+b.offsetTop||b.offsetTop>a.offsetHeight+a.offsetTop)},O=function(b){return p().some(function(a){return a.attributes.currentCell.value.split("-")[1]===b})};(function(){for(var b=0;32>b;b++){var c=document.createElement("div");document.getElementById("enemies").appendChild(c);c.classList.add("ship-row");
